...
void GoodsFunction::DeleteGoodsInfo()
{
	...
	{   cout<<"===========================================================================\n"; 
		...
		{     isRight=1;
		      output1();		
        cout<<q->next->code<<"\t"<<q->next->name<<"\t"<<q->next->place<<"\t"<<q->next->price<<"\t"
		<<q->next->num<<"\t"<<q->next->totalPrice<<"\t"<<endl;
              output2();
...
void GoodsFunction::DisplayGoodsInfo()
{
	...
	while(p->next!=NULL)
	{
		p=p->next;
		output1();		
    cout<<p->code<<"\t"<<p->name<<"\t"<<p->place<<"\t"<<p->price<<"\t"
	<<p->staticnum<<"\t"<<p->staticnum*p->price<<"\t"<<endl;
        output2();
    cout<<p->type<<"\t\t"<<p->brand<<"\t\t"<<p->year<<"/"<<p->month<<"/"<<p->day<<endl;	 
	cout<<"===========================================================================\n";
	}
